...
def check_bids_folder_does_not_exist(parent: GirderModel, folder_name: str) -> None:
    folder_list = list(BIDSFolderModel().find(query={"parentId": parent["_id"], "name": folder_name}))
...
def test_create_subject_in_folder_raises_error(db: Any, folder: GirderModel, user: GirderModel) -> None:
    subject_folder_name = "sub-01"
